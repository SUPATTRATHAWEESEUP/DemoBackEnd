...
namespace DemoStandardProject.Services
{
    public class ProductGroupService : IProductGroupService
    {
        ...
        public async Task<ServiceResponse<List<ProductGroupDto>>> AddProductGroup(ProductGroupDto newproductgroup)
        {
            ServiceResponse<List<ProductGroupDto>> res = new ServiceResponse<List<ProductGroupDto>>();
            ProductGroup productGroup = _mapper.Map<ProductGroup>(newproductgroup);
